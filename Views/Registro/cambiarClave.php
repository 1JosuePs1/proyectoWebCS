                ...
                <div class="card shadow-lg border-0 rounded-lg">
                    ...
                    <div class="card-body p-4">
                        <form action="" method="post" id="formLogin">
                            ...
                            <div class="d-grid">
                                <button type="submit" onclick="window.location.href='../../Views/Home/Home.php'" class="btn backgroundPrincipal btn-lg text-white">Cambiar Contraseña</button>
                            </div>
                        </form>
                    </div>
                    
                    <div class=" text-center py-3">
                                            <small class="text-muted textLink"><a href="../../Views/Registro/login.php" class="text-primary">Volver a Iniciar Sesión</a></small>
                    </div>
                </div>
            </div>
        </div>
