                ...
                <div class="card shadow-lg border-0 rounded-lg">
                        ...
                        <div class="card-body p-4">
                            <form action="../../Controllers/registroController.php" method="POST" id="formAuth">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="email" class="form-control" id="InputEmail" name="correoUsuario" placeholder="Correo" required>
                                    <label for="InputEmail">Correo electrónico</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="password" class="form-control" id="InputPassword" name="passwordUsuario" placeholder="Contraseña" required>
                                    <label for="InputPassword">Contraseña</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="password" class="form-control" id="InputPasswordConfirm" name="confirmPassword" placeholder="Confirmar" required>
