...
// 2. Identificar la página actual para el estado "active"
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAdmin">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= ($urlActual == 'gestionProductos.php') ? 'active' : '' ?>" href="/proyectoWebCS/Views/Admin/listaProductos.php">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= ($urlActual == 'reporteVentas.php') ? 'active' : '' ?>" href="/proyectoWebCS/Views/Admin/pedidos.php">
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="/proyectoWebCS/config/cerrarSesion.php" class="btn btn-outline-light btn-sm">
